...
import HomeScreen from '../../screens/DGPIGP/HomeScreen';
import SearchScreen from '../../screens/DGPIGP/SearchScreen';
import ProfileScreen from '../../screens/DGPIGP/ProfileScreen';
import ReportScreenNavigation from './ReportScreenNavigation';
import DIG from '../../screens/DGPIGP/DIG'
                ...
                options={{
                    tabBarIcon: ({ focused }) => {
                        return (
                            <View style={{ alignItems: "center", justifyContent: "center" }}>
                               <Image
                                source={focused ? icons.DIG_fill : icons.DIG}
                                resizeMode='contain'
                                style={{
                                    height: 24,
                                    width: 24,
                            ...
                            />
                                <Text style={{ fontSize: 10, color: "#16247d", marginTop:5  }}>DIG</Text>
                            </View>
                        )
                    }
                }}
