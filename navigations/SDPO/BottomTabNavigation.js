...
import HomeScreen from '../../screens/SDPO/HomeScreen';
import SearchScreen from '../../screens/SDPO/SearchScreen';
import PoliceStation from '../../screens/SDPO/PoliceStation';
import ProfileScreen from '../../screens/SDPO/ProfileScreen';
                ...
                options={{
                    tabBarIcon: ({ focused }) => {
                        return (
                            <View style={{ alignItems: "center", justifyContent: "center" }}>
                               <Image
                                source={focused ? icons.PS : icons.PS_Outline}
                                resizeMode='contain'
                                style={{
                                    height: 24,
                                    width: 24,
                            ...
                            />
                                <Text style={{ fontSize: 10, color: "#16247d", marginTop:5}}>Police Station</Text>
                            </View>
                        )
                    }
                }}
