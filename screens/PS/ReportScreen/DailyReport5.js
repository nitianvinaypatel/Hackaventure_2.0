  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <ScrollView style={{ flex: 1, marginBottom: 60 }}>
        <View>
          <Text style={{ fontSize: 20, fontWeight: '700', marginHorizontal: 10, textAlign: 'center' }}>Law & Order Situation</Text>
          <Text style={{ fontSize: 16, fontWeight: '700', marginHorizontal: 10, marginTop: 20 }}>Status:</Text>
          <TextInput
            style={[styles.input, { textAlignVertical: 'top' }]}
            placeholder="Enter status of law & order."
