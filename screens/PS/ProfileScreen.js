  ...
  return (
    ...
    <ScrollView>
      ...
      <View style={{flex:1, flexDirection:'row',marginBottom:10, padding:5, height:50, borderRadius:20, justifyContent:'space-between', alignItems:'center', backgroundColor:COLORS.gray}} >
        ...
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >PS</Text>
        </View>
        ...
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >Bawngkawn PS</Text>
        </View>
        ...
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >Bawngkawn@google.com</Text>
        </View>
