  ...
  return (
    ...
    <ScrollView>
      ...
      <View style={{flex:1, flexDirection:'row',marginBottom:10, padding:5, height:50, borderRadius:20, justifyContent:'space-between', alignItems:'center', backgroundColor:COLORS.gray}} >
        ...
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >Admin</Text>
        </View>

        <View style={{flex:1, flexDirection:'row',marginBottom:10, padding:5, height:50, borderRadius:20, justifyContent:'space-between', alignItems:'center', backgroundColor:COLORS.gray}} >
        <Text style={{fontSize:18,fontWeight:600, marginLeft:10}} >ID:</Text>
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >12345678</Text>
        </View>

        <View style={{flex:1, flexDirection:'row',marginBottom:10,  padding:5, height:50, borderRadius:20, justifyContent:'space-between', alignItems:'center', backgroundColor:COLORS.gray}}>
        <Text style={{fontSize:18,fontWeight:600, marginLeft:10}} >Name:</Text>
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >Vinay Patel</Text>
        </View>
        ...
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >Vinay@google.com</Text>
        </View>


        <View style={{flex:1, flexDirection:'row',marginBottom:10,  padding:5, height:50 , borderRadius:20, justifyContent:'space-between', alignItems:'center', backgroundColor:COLORS.gray}} >
        <Text style={{fontSize:18,fontWeight:600, marginLeft:10}} >Address:</Text>
        <Text style={{fontSize:16,fontWeight:500, marginRight:10}} >Bawngkawn, Aizawl, Mizoram</Text>
        </View>
