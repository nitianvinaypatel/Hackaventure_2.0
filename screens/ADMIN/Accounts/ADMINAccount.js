...
const ADMINAccount = ({ navigation }) => {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <HeaderWithBack title={"ADMIN"} imageSource={icons.back} onPress={() => navigation.goBack()} />

      <ScrollView style={{ flex: 1, marginBottom: 60}}>

<View >
      <Text style={{ fontSize: 18, fontWeight: '700', marginHorizontal: 10 ,marginTop:10}}>Name of Admin:</Text>
      <TextInput
        style={styles.input}
